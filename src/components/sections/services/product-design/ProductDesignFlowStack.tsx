...
import type { ProductDesignWorkflowStep } from "@/types/product-design-service";

function ProductDesignFlowCardItem({
  item,
  index,
  total,
  progress,
}: {
  item: ProductDesignWorkflowStep;
  index: number;
  total: number;
...
export default function ProductDesignFlowStack() {
  const containerRef = useRef<HTMLElement | null>(null);
  const { steps } = productDesignServiceData;
