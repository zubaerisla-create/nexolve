...
import type { CloudServicesWorkflowStep } from "@/types/cloud-services-service";

function CloudFlowCardItem({
  item,
  index,
  total,
  progress,
}: {
  item: CloudServicesWorkflowStep;
  index: number;
  total: number;
...
export default function CloudServicesFlowStack() {
  ...
  const cards = cloudServicesServiceData.steps;
